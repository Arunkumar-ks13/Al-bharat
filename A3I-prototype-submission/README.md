...
### Key Features
- 🎯 **Dual Service Support**: Education Scholarships & Farmer Welfare Schemes
- 🌐 **Multi-Language**: English, Hindi, Tamil (UI & PDF output)
- 🤖 **AI-Powered**: Smart form filling using Claude 3 Haiku
